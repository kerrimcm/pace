...
class MeetupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meetup" do
    assert_difference('Meetup.count') do
      post meetups_url, params: { meetup: { latitude: @meetup.latitude, longitude: @meetup.longitude, name: @meetup.name } }
    end
  ...
  test "should update meetup" do
    patch meetup_url(@meetup), params: { meetup: { latitude: @meetup.latitude, longitude: @meetup.longitude, name: @meetup.name } }
